<aside class="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
    ...
    <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
        <a href="/dashboard" class="hover:ml-4 w-full text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
        ...
        <a href="/withdraw" class="hover:ml-4 w-full text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
    ...
    <div class="mini mt-20 flex flex-col space-y-2 w-full h-[calc(100vh)]">
        <a href="/dashboard" class="hover:ml-4 justify-end pr-5 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
        ...
        <a href="/withdraw" class="hover:ml-4 justify-end pr-5 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
                <g transform="translate(-4.000000, -879.000000)">
                    <path d="M21,889 L21,886.207 L22,889 L21,889 Z M22,897 L6,897 L6,891 L10,891 L10,895 L18,895 L18,891 L22,891 L22,897 Z M7,886.207 L7,889 L6,889 L7,886.207 Z M9,881 L19,881 L19,889 L16,889 L16,893 L14.966,893 L14.933,885.721 L16.812,887.6 L18.226,886.186 L13.984,881.943 C11.826,884.101 12.739,883.188 9.691,886.236 L11.084,887.671 L13.034,885.721 L13.012,893 L12,893 L12,889 L9,889 L9,881 Z M22,883 L21,883 L21,879 L7,879 L7,883 L6,883 L4,889.207 L4,899 L24,899 L24,889.207 L22,883 Z">
                    </path>
