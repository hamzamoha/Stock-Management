        ...
        <main class="relative p-3" style="margin-left: 80px;">
            ...
            <div id="content" class="h-full mb-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 py-4 gap-4">
                    <div
                        class="bg-green-500 dark:bg-green-900 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-600 dark:border-green-700 text-white font-medium group">
                        <div
                    ...
                    <div
                        class="bg-red-500 dark:bg-red-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-red-600 dark:border-red-700 text-white font-medium group">
                        <div
                            class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                            <svg width="30" height="30" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor"
